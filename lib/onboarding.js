...
function getProviderOnboardingSteps({ hasVerificationBanner = false } = {}) {
  const steps = [
    {
      ...
      body: 'Bienvenido a Zilo Pro. Aquí gestionas tu disponibilidad, trabajos y reputación profesional.'
    }
  ];
  ...
  steps.push(
    ...
    },
    {
      ...
      body: 'Solo recibirás trabajos de las categorías que Zilo te asignó. Si necesitas ampliarlas, contacta soporte.'
    },
    {
